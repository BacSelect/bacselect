#!/usr/bin/env python3
"""Run blinded selector-v1 leave-one-feature-out validation."""
...
def build_report(
    ...
    if row_count != expected_rows:
        raise AssertionError(
            f"LOFO row count changed: {row_count}"
        )
...
def main() -> None:
    ...
    print(
        "PASS | identity-blind LOFO report"
    )
    print(
        f"lofo_sha256 | {output_hash}"
    )
